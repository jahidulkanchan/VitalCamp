...
const UserHome = () => {
  ...
  return (
    <section className="mt-10 max-w-2xl mx-auto rounded-2xl bg-white shadow-md py-10">
      <div className="flex-col flex md:flex-row gap-5 px-2 md:px-10 justify-center items-center">
        <img
          className="w-[100px] h-[100px] object-cover md:h-[180px] rounded-full md:w-[180px] border"
          src={user?.photoURL}
          alt="user Image"
        />
        <div>
          ...
          <p className="md:text-md flex text-slate-500 items-center gap-2">
            <span className="text-primary">
              <BiSolidEnvelope />
            </span>{" "}
            {user?.email || "User Email"}
          </p>
          <p className="px-3 mt-2 py-[2px] bg-primary text-white w-fit rounded-full text-xs text-center ">Participant</p>
          <button
